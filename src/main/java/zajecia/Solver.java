...
public class Solver {
    ...
    public Wyniki bisection(double a, double b, double blad, int maxIter) {
        double c = a;
    ...
    public Wyniki fixedPoint(double x0, double relError, int maxIter) {
    ...
    public Wyniki metodaSiecznych(double x0, double x1, double relError, int maxIter) {
        InitalieListAndAddFirstValues(x0);
        wyniki.add(x1);
    ...
    public Wyniki metodaStycznych(double x0, double relError, int maxIter, Function dFunction) {
        InitalieListAndAddFirstValues(x0);
        int i = 0;
        while (relError < Math.abs(epsilonA.get(i))) {
    ...
    public Wyniki regularFalsi(double a, double b, double relError, int maxIter) {
        double c = a;
        InitalieListAndAddFirstValues(c);
        int i = 0;
        while (relError < Math.abs(epsilonA.get(i))) {
